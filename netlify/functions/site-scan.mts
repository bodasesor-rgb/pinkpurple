...
function guessCountry(text: string): { code: string; name: string } {
  ...
  const map: [RegExp, string, string][] = [
    [/\bcanad[aá]\b|\bontario\b|\bquebec\b|\btoronto\b/, 'CA', 'Canadá'],
    [/\bunited states\b|\busa\b|\bcalifornia\b|\btexas\b|\bflorida\b|\bnew york\b/, 'US', 'Estados Unidos'],
    [/\bm[eé]xico\b|\bmx\b|\bcdmx\b|\bjalisco\b|\bnuevo le[oó]n\b/, 'MX', 'México'],
    [/\bguatemala\b/, 'GT', 'Guatemala'],
    [/\bbelize\b|\bbelice\b/, 'BZ', 'Belice'],
    [/\bel salvador\b|\bsan salvador\b/, 'SV', 'El Salvador'],
    [/\bhonduras\b|\btegucigalpa\b/, 'HN', 'Honduras'],
    [/\bnicaragua\b|\bmanagua\b/, 'NI', 'Nicaragua'],
    [/\bcosta rica\b|\bsan jos[eé]\b/, 'CR', 'Costa Rica'],
    [/\bpanam[aá]\b/, 'PA', 'Panamá'],
    [/\bcuba\b|\bla habana\b/, 'CU', 'Cuba'],
    [/\brep[uú]blica dominicana\b|\bsanto domingo\b|\bdominican\b/, 'DO', 'República Dominicana'],
    [/\bhait[ií]\b|\bport-au-prince\b/, 'HT', 'Haití'],
    [/\bjamaica\b|\bkingston\b/, 'JM', 'Jamaica'],
    [/\btrinidad\b|\btobago\b/, 'TT', 'Trinidad y Tobago'],
    [/\bbahamas\b|\bnassau\b/, 'BS', 'Bahamas'],
    [/\bbarbados\b|\bbridgetown\b/, 'BB', 'Barbados'],
    [/\bpuerto rico\b|\bsan juan\b/, 'PR', 'Puerto Rico'],
    [/\bcolombia\b|\bbogot[aá]\b|\bmedell[ií]n\b/, 'CO', 'Colombia'],
    [/\bvenezuela\b|\bcaracas\b/, 'VE', 'Venezuela'],
    [/\bguyana\b|\bgeorgetown\b/, 'GY', 'Guyana'],
    [/\bsurinam\b|\bparamaribo\b/, 'SR', 'Surinam'],
    [/\bbrasil\b|\bbrazil\b|\bs[aã]o paulo\b|\brio de janeiro\b/, 'BR', 'Brasil'],
    [/\becuador\b|\bquito\b|\bguayaquil\b/, 'EC', 'Ecuador'],
    [/\bper[uú]\b|\blima\b/, 'PE', 'Perú'],
    [/\bbolivia\b|\bla paz\b|\bsanta cruz\b/, 'BO', 'Bolivia'],
    [/\bparaguay\b|\basunci[oó]n\b/, 'PY', 'Paraguay'],
    [/\bchile\b|\bsantiago\b/, 'CL', 'Chile'],
    [/\bargentina\b|\bbuenos aires\b|\bcaba\b/, 'AR', 'Argentina'],
    [/\buruguay\b|\bmontevideo\b/, 'UY', 'Uruguay'],
  ];
