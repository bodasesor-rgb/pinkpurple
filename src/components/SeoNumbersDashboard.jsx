/**
 * Mock del panel “Tu sitio web en números” — cifras de demo impactantes.
 */
export default function SeoNumbersDashboard() {
  return (
    <section className="seo-dash" aria-labelledby="seo-dash-title">
      ...
      <div className="seo-dash__grid">
        <div className="seo-dash__col">
          ...
          <article className="seo-dash__card seo-dash__card--score">
            <div className="seo-dash__card-top">
              <h3>
                Puntuación SEO on-page
                <span className="seo-dash__q" title="Calidad on-page de tus páginas">
                  ?
                </span>
              </h3>
          ...
          <article className="seo-dash__card">
            <h3>
              ...
              <span className="seo-dash__q" title="Issues técnicos o de contenido">
                ?
              </span>
            </h3>
        ...
        <div className="seo-dash__col">
          ...
          <div className="seo-dash__split">
            <article className="seo-dash__card seo-dash__card--half">
              <h3>
            ...
            <article className="seo-dash__card seo-dash__card--half">
              ...
              <div className="seo-dash__tracked">
                ...
                <span className="seo-dash__pill seo-dash__pill--down">↘ 12 DOWN</span>
              </div>
            </article>
          </div>
      ...
      <p className="seo-dash__note">Demo ilustrativa · mes a mes · resultados tipo panel PinkPurple SEO</p>
    </section>
  );
}
